...
ifdef CM_RELEASE
    ...
    ifeq ($(PRODUCT_VERSION_MINOR),0)
        ...
        CF_VERSION := $(PRODUCT_VERSION_MAJOR).$(shell date -u +%y%m%d%H%M) ($(CM_BUILDTYPE)$(CM_EXTRAVERSION))
    else
        CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(shell date -u +%y%m%d%H%M)-$(CM_BUILDTYPE)-$(CM_BUILD)$(CM_EXTRAVERSION)
        CF_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(shell date -u +%y%m%d%H%M) ($(CM_BUILDTYPE)$(CM_EXTRAVERSION))
    endif
endif
